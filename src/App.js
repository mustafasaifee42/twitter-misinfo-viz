    ...
    <div className="App">
      ...
      <div className="share-header">
        <div className='share share-top'>
          ...
          <div className='icons'>
            <FacebookShareButton url='https://curiouscaseof8866288662.netlify.com/' quote="Curious case of 88662 88662: Misinformation and campaign on Twitter: ">
              <FacebookIcon size={32} round={true} />
            </FacebookShareButton>
            <TwitterShareButton url='https://curiouscaseof8866288662.netlify.com/' title="Curious case of 88662 88662: Misinformation and campaign on Twitter: ">
